...
router.get('/recuperandoPublicacoes', function(req, res, next) {
	...
	if (env == 'dev') {
		// abaixo, escreva o select de dados para o Workbench
		instrucaoSql = "select nomeMod, nomeTenis, marcaTenis, dataLancamento, `drop`, numDrop from tb_postagem inner join tb_moderador on fkmoderador=idmoderador";
	} else if (env == 'production') {
		// abaixo, escreva o select de dados para o SQL Server
